...
function Footer() {
 ...
 <div className='text-center'>
            ...
            <ul className='space-y-2 text-sm'>
                ...
                <li className='text-gray-300 hover:text-white transition-colors'>support@futurexplore.com</li>
            </ul>
        </div>
     ...
     <p className='text-center text-xs text-gray-500'>
        © {new Date().getFullYear()} FutureXplore ExamNotes AI. All rights reserved.
     </p>
